...
public class ExtentReport4Demo {
	...
	public void setExtent() {
		htmlReporter = new ExtentHtmlReporter("./test-output/TestReport" + Genaric.getDate() + ".html");
		...
		extent.setSystemInfo("os", Genaric.getOs());
		extent.setSystemInfo("Tester Name", Genaric.getHostName());
